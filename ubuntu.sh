...
sudo apt install -y exiftool make tmux btop cmatrix cbonsai cowsay unzip curl wget dpkg jq zoxide neovim python3 nodejs npm ripgrep stow python3-pwntools
